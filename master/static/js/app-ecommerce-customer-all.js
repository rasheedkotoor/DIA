    ...
    o.length && (o = o).wrap('<div class="position-relative"></div>').select2({ placeholder: "United States ", dropdownParent: o.parent() }),
        n.length &&
            ((e = n.DataTable({
                ...
                columns: [{ data: "" }, { data: "id" }, { data: "student" }, { data: "student_id" }, { data: "class" }, { data: "number" }, { data: "murshid" }],
                columnDefs: [
                    {
                        className: "control",
                        searchable: !1,
                            ...
                            return (
                                ...
                                (r
                                    ...
                                    : '<span class="avatar-initial rounded-circle bg-label-' +
                                      ...
                                      '">' +
                                      (r = (((r = (n = s.customer).match(/\b\w/g) || []).shift() || "") + (r.pop() || "")).toUpperCase()) +
                                      "</span>") +
                    ...
                    },
                    {
                        ...
                        render: function (e, t, s, a) {
                            ...
                            return (
                                ...
                                (s ? `<i class ="fis fi fi-${s} rounded-circle me-2 fs-3"></i>` : '<i class ="fis fi fi-xx rounded-circle me-2 fs-3"></i>') +
                                "</div><div><span>" +
                                n +
                                "</span></div></div>"
                            );
                ...
                order: [[2, "desc"]],
                dom:
                    '<"card-header d-flex flex-wrap py-3"<"me-5 ms-n2"f><"dt-action-buttons text-xl-end text-lg-start text-md-end text-start d-flex align-items-center justify-content-md-end gap-3 gap-sm-2 flex-wrap flex-sm-nowrap"lB>>t<"row mx-2"<"col-sm-12 col-md-6"i><"col-sm-12 col-md-6"p>>',
        ...
        e &&
            ...
            FormValidation.formValidation(t, {
                fields: {
                    ...
                    customerEmail: { validators: { notEmpty: { message: "Please enter your email" }, emailAddress: { message: "The value is not a valid email address" } } },
                },
                plugins: {
